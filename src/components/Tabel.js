      ...
      >
        ...
        <div className="body-tabel">
          ...
          <div className="flex items-center gap-[10px] md:gap-[25px] justify-center m-[10px]">
            <input
              ...
              className="w-[150px] h-[30px] md:w-[200px] lg:w-[400px] lg:h-[40px] text-[15px] rounded-[5px]  py-[10px] px-10px"
            />
            <span>
              <select
        ...
        <div className=" flex items-center justify-center">
          <div className="text-[white] text-center bg-[#6c5f5b]  w-[300px]   md:w-[500px] lg:w-[700px]  md:w-[500px]   rounded-tr-[50px] rounded-bl-[50px] lg:p-[40px] p-[20px] lg:mt-[20px] lg:mb-[20px] md:mt-[15px] md:mb-[15px] mt-[10px] mb-[10px]">
            <h3 className="text-[13px] md:text-[16px] lg:text-[25px]">Thank you for choosing Dz's Rental Rooms!</h3>
        ...
        >
          {" "}
          <p 
          className="text-[13px] md:text-[15x] lg:text-[20px] text-black"
        ...
        <div
          className="a.href text-center flex justify-center text-black text-[13px] gap-[10px] md:text-[15px] lg:text-[20px]"
